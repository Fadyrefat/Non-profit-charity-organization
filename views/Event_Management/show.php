...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; padding: 10px 20px; background: #3498db; color: #fff; text-decoration: none; border-radius: 6px; margin-top: 10px; }
...
<div class="card">
    ...
    <?php if (!empty($attendees)): ?>
        <table>
            <thead>
                <tr>
                    <th>Name</th><th>Email</th><th>Phone</th><th>Type</th><th>Ticket</th><th>Checked In</th><th>Action</th>
                </tr>
            </thead>
            <tbody>
